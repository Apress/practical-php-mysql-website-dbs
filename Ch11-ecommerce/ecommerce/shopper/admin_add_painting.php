...
if (empty($errors)) { // If no errors were encountered
	// Register the painting in the database
		...
		// Make the query:'
		$q = "INSERT INTO art (art_id, thumb, type, price, medium, artist, mini_descr, ppcode) VALUES (' ', '$thumb', '$type', '$price', '$medium', '$artist', '$mini_descr', '$ppcode' )";		
...
<strong>Digits only, no &pound; or $ symbols </strong>
</p>
