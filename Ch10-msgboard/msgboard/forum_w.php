...
// Make the query
$q = "SELECT uname,post_date,subject,message FROM forum WHERE subject = 'Wise Quotes' ORDER BY 'post_date' ASC";
$result = mysqli_query( $dbcon, $q ) ;
if ( mysqli_num_rows( $result ) > 0 )
{
  echo '<h2>Wise Quotes</h2><table><tr><th>Posted By</th><th>Forum</th><th id="msg">Quotation</th></tr>';
